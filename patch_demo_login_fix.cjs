...
let code1 = code.indexOf('        onDemoLogin={(demoRole) => {');
let code2 = code.indexOf('        }}', code1 + 10);
let codeTarget = code.substring(code1, code2 + 10);

code = code.replace(codeTarget, targetStr);
